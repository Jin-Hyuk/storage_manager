...
public class Revenue_monthly extends Activity {
	String databaseName;
    ...
    */
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.revenue_monthly);
        ...
        for(int i=0; i<6; i++){
        	 ...
        	 String a = String.valueOf(yearint);
        	 a += "-";        	
        	 if(monthint > 9){
        		 
        	 
        	 a += String.valueOf(monthint);
        	 }
        	 else
        	 {
        	 String monthint0 = "0";
        	 
        	 monthint0 += String.valueOf(monthint);
        ...
        spinner1 = (Spinner)findViewById(R.id.spinner1);
      	...
      	adapter3=new ArrayAdapter(this,android.R.layout.simple_spinner_item,listm);
    ...
    //  selected_item2 = str;
     ...
     spinner1.setOnItemSelectedListener(new OnItemSelectedListener() {
  		...
  		public void onItemSelected(AdapterView<?> parentView2,
  			...
  			selected_month = String.valueOf(adapter3.getItemId(position2));
  			}
  		@Override
     ...
     int money_result=0;
      //where에서 오늘을 어떻게 검색하지??
        ...
        Cursor cursor_in = database.rawQuery("SELECT name, ea, price, today FROM  buy_table WHERE today like '"+selectedm+"%'", null);
        ...
        Cursor cursor_out = database.rawQuery("SELECT name, ea, price, today FROM  sell_table WHERE today like '"+selectedm+"%'", null);
